...
# VerifyToken Deployment Script
# Usage: ./deploy-verify.sh <network>
...
echo "🚀 Deploying VerifyToken to $NETWORK..."
echo "RPC URL: $RPC_URL"
echo "Initial recipient: 0x7411a46800a1094d3fFF237b39f0624Fc1A434C3"
echo "Initial supply: 1,000,000,000 VERIFY tokens"

forge script script/DeployVerifyToken.s.sol --rpc-url $RPC_URL --broadcast $VERIFY

echo "✅ VerifyToken deployment complete!"
